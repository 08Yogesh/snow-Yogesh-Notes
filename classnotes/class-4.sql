create schema  hr.departments;

create table departments(department_id int,
                         department_name varchar(30),
                         l0ocation_id int)

INSERT INTO departments(department_id,department_name,l0ocation_id) 
...
create table countries(country_id CHAR (2) ,
...
select * from employees where salary>=10000;
 ...
 select  EMPLOYEE_ID,FIRST_NAME,EMAIL,SALARY,MANAGER_ID from employees;
 select  EMPLOYEE_ID,FIRST_NAME,EMAIL,SALARY,MANAGER_ID from employees where EMPLOYEE_ID in(100,104,107);
select  EMPLOYEE_ID,FIRST_NAME,EMAIL,SALARY,MANAGER_ID from employees where FIRST_NAME like 'W%';
select  EMPLOYEE_ID,FIRST_NAME,EMAIL,SALARY,MANAGER_ID from employees where FIRST_NAME like 'N%' and SALARY>=15000;
...
select FIRST_NAME ,count(FIRST_NAME) from employees group by FIRST_NAME having count(*)>1;
select max(SALARY) from employees;
select min(SALARY) from employees;
select sum(SALARY)from employees;
select EMPLOYEE_ID,sum(salary) from employees group by EMPLOYEE_ID ;
--select * from employees where salary between 10000 and 20000(select count(salary) from employees)
select *from employees where salary between 10000 and 20000;
...
undrop table dependents;
drop table employees
 select EMPLOYEE_ID,FIRST_NAME,SALARY ,
 case when SALARY<=10000 then 'JrEmployee' else 'SrEmployee' as catagery end from employees;
